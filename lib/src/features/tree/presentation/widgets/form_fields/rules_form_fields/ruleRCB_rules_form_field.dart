...
class RuleRCBRulesFormField extends StatelessWidget {
  const RuleRCBRulesFormField({super.key});

  String? validator(String? value) {
    if (value == null) {
      return 'Rule RCB required!';
